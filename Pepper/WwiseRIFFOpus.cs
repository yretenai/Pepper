...
public sealed record WwiseRIFFOpus : AbstractRIFFFile {
    private static readonly byte[][] MappingMatrix = { new byte[] { 0 }, new byte[] { 0, 1 }, new byte[] { 0, 2, 1 }, new byte[] { 0, 1, 2, 3 }, new byte[] { 0, 4, 1, 2, 3 }, new byte[] { 0, 4, 1, 2, 3, 5 }, new byte[] { 0, 6, 1, 2, 3, 4, 5 }, new byte[] { 0, 6, 1, 2, 3, 4, 5, 7 } };
